...
| [`+messages-edit`](references/lark-im-messages-edit.md) | Edit a message's content (text/post, including the attachment zone); user/bot; PATCH /open-apis/im/v1/messages/:message_id |
